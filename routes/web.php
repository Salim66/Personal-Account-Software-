...
Route::middleware(['auth'])->group(function () {
    ...
    // Report All Routes
    Route::get('/report/page', [AdminController::class, 'reportPage'])->name('report.page');
    Route::get('/search-reaport', [AdminController::class, 'searchReport']);
    Route::get('/search-total-overview', [AdminController::class, 'totalOverview']);
